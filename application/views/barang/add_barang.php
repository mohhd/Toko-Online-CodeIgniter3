    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control" cols="30" rows="5" placeholder="Deskripsi Barang"><?= set_value('deskripsi') ?></textarea>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <img src="<?= base_url('assets/gambar/no-photo.jpg') ?>" id="gambar_load" width="400px">
                    </div>
                </div>
            </div>
